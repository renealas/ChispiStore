...
class _AuthCardState extends State<AuthCard>
  ...
  void _showErrorDialog(String message) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text('Un Error a Ocurrido!'),
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errorMessage = 'Autenticacion Fallo';
      if (error.toString().contains('EMAIL_EXISTS')) {
        errorMessage = 'Este correo ya se encuentra en uso.';
      } else if (error.toString().contains('INVALID_EMAIL')) {
        errorMessage = 'Esto no es un Correo Valido.';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'Esta Contraseña es muy Debil';
      ...
      print(error);
      const errorMessage = 'No se pudo Autenticar trate de nuevo';
      _showErrorDialog(errorMessage);
    }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                        ...
                        validator: _authMode == AuthMode.Signup
                            ? (value) {
                                if (value != _passwordController.text) {
                                  return 'No se pudo confirmar ya que Password es distinto!';
                                }
                              }
                            : null,
                      ),
                ...
                FlatButton(
                  child: Text(
                      'CAMBIAR A ${_authMode == AuthMode.Login ? 'REGISTRARSE' : 'ACCEDER'}'),
